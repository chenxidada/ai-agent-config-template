...
4. `task-planner` - Define the smallest safe fix slice
5. **Human Gate** - Present diagnosis and fix plan, wait for confirmation
6. `implementer` - Apply the minimal repair
7. `reviewer` - Check fix is narrowly scoped, no hidden quality issues
