...
<!--
  This snippet defines the unified escalation framework for ALL TRAE Agents and the TRAE Agent (Orchestrator).
...
Every escalation MUST carry one of these four levels. The level determines what the TRAE Agent does with it.

| Level | Name | Meaning | TRAE Agent Response |
|:-----:|------|---------|----------------------|
...
## Escalation Response Protocol (TRAE Agent)
