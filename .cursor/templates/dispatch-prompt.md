...
→ `.specdev/specs/{slug}/ui-spec.md`（**仅当 UI 相关性判定为 true**，按 `.cursor/templates/ui-spec-output.md`）
```
...
1. 执行 `python3 .cursor/skills/ui-ux-pro-max/scripts/search.py "<产品> <行业> <关键词>" --design-system --persist -p "{slug}"`
